...
void CShotgun::PrimaryAttack()
{
	...
	PLAYBACK_EVENT_FULL(0, m_pPlayer->edict(), m_usSingleFire, 0.0, g_vecZero, g_vecZero, vecDir.x, vecDir.y, 0, 0, 0, 0);
...
void CShotgun::SecondaryAttack()
{
	...
	PLAYBACK_EVENT_FULL(0, m_pPlayer->edict(), m_usDoubleFire, 0.0, g_vecZero, g_vecZero, vecDir.x, vecDir.y, 0, 0, 0, 0);
