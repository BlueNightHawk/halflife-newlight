...
void CEgon::Attack()
{
	...
	case FIRE_OFF:
	{
		...
		PLAYBACK_EVENT_FULL(0, m_pPlayer->edict(), m_usEgonFire, 0.0, g_vecZero, g_vecZero, 0.0, 0.0, 0, m_fireMode, 1, 0);
	...
	case FIRE_CHARGE:
	{
		...
		{
			PLAYBACK_EVENT_FULL(0, m_pPlayer->edict(), m_usEgonFire, 0, g_vecZero, g_vecZero, 0.0, 0.0, 0, m_fireMode, 0, 0);
			pev->fuser1 = 1000;
		}
